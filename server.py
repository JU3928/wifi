...
def load_passwords(wordlist_path: str = None) -> list:
    ...
    passwords += [
        ...
        "87654321", "88888888", "00000000", "11111111", "22222222",
        "33333333", "44444444", "55555555", "66666666", "77777777",
        "99999999", "11223344", "12341234", "12344321", "43211234",
        "12121212", "13131313", "01010101", "10101010",
    ]

    # --- 纯数字6-10位常见 ---
    passwords += [
        "000000", "111111", "222222", "333333", "444444", "555555",
        "666666", "777777", "888888", "999999", "121212", "131313",
        "123123", "321321", "111222", "222333", "333444", "555666",
        "777888", "888999", "000111", "147258", "258369",
        "0987654321", "9876543210", "0123456789",
        "888888888", "666666666", "555555555", "12345678901",
    ]
    ...
    passwords += [
        ...
        "admin", "admin123", "admin888", "admin666", "admin168",
        "qwertyuiop", "qwerty123", "qweasdzxc", "asdfghjkl",
        "abc123", "abc12345", "abcd1234", "a1234567", "a12345678",
        "Aa123456", "ABC12345", "Abc123456",
        "@1234567", "@8888888", "qwer1234",
        "iloveyou", "iloveyou1", "welcome", "welcome1",
        "hello123", "master123", "test1234",
        "sunshine", "sunshine1", "monkey123",
        "dragon123", "letmein1",
    ]
    ...
    passwords += [
        ...
        "mima000000", "mima111111",
        "luyou888", "luyou8888",
        "zhongguo", "zhongguo123",
        "xiao123456", "xiao8888",
        "woaini1314", "woai123456",
    ]

    # --- 路由器默认密码 ---
    passwords += [
        "admin", "tplink", "tplink123", "admin888",
        "admin666", "admin168", "admin2024", "admin2025",
        "root123", "super123", "guest123",
    ...
    passwords += [
        ...
        "20080808", "20101010", "20200101",
        "1231", "1024", "5201314", "1314520", "1314521",
    ]
    ...
    passwords += [
        ...
        "qwertyuiop", "1q2w3e4r", "1q2w3e4r5t",
    ]

    # --- 其他常见 ---
    passwords += [
        "aabbccdd", "a1b2c3d4", "abcd123456",
        "zxcvbnm123", "zaq12wsx", "qazwsxedc",
        "1qaz2wsx", "1q2w3e4r5t6y",
        "0o0o0o0o", "o0o0o0o0",
        "zzzzzzzz", "88889999",
        "12369874", "14789632", "159753",
        "168168", "518518", "888518",
        "666888", "888666", "520520",
        "131420", "7758521",
        "qwerty123456", "123456qwerty",
        "changeme", "letmein", "trustno1",
        "11111111a", "a11111111",
        "1a2b3c4d", "12qwaszx",
    ]

    # 去重 & 过滤非法长度（WPA2 至少 8 位）
    seen = set()
    result = []
    for p in passwords:
        p = p.strip()
